...
bool ModuleWindow::Init() {
	...
	if (SDL_Init(SDL_INIT_VIDEO)<0) {
		...
		window = SDL_CreateWindow("Super Soukoban || by Serapios", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH * SCREEN_SIZE, SCREEN_HEIGHT * SCREEN_SIZE,flags);
